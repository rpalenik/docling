#!/usr/bin/env python3
"""
Hierarchy-based document reconstruction for Docling documents.

This module implements a hierarchy-based reconstruction of the entire
Docling document into a complete hierarchical JSON structure. Unlike the
sequential approach, this uses docling's parent/children reference system
to traverse the full document hierarchy, ensuring no levels are missed.
...
def reconstruct_document_hierarchy(doc: DoclingDocument) -> Dict[str, Any]:
    ...
    structure = {
        ...
        "metadata": {
            ...
            "reconstruction_method": "hierarchy_based",
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Hierarchy-based document reconstruction - Pass 1')
    ...
    log_progress("INFO", "Hierarchy-Based Document Reconstruction - Pass 1")
    log_progress("INFO", "=" * 70)
    ...
    json_output = output_dir / f"{base_name}_reconstructed_hierarchy.json"
    md_output = output_dir / f"{base_name}_reconstructed_hierarchy.md"
